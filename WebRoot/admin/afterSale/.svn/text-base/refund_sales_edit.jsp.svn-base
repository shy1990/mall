...
<!-- 左边快捷按钮 -->
	...
	<div class="xq_mian">
	  <div class="xq_mian_top"><span><a href="javascript:history.go(-1);">返回</a></span>当前位置&gt;&gt;<h5>修改退款退货申请</h5></div>
	  <div class="tijsq_main">
	    <div class="tijsq_main_01">
		    <table border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    <td width="103" align="center">修改申请</td>
			    <td width="103">&nbsp;</td>
		...
		<form id="refund_sales_form" action="th/editTh.html" method="post">
			...
			<div class="tijsq_main_02">
			    ...
			    <div class="tijsq_main_05_ret">
			       <input id="thPrice" type="text" name="money" value="${msg.obj.money }" />
			    </div>
			    <div class="tijsq_main_05_ret">
			      <h4></h4></div>
			    <div class="clear"></div>
		    ...
		    <div class="tijsq_main_03">
		      ...
		      <div class="tijsq_main_05_ret">
		        <textarea id="textarea" name="remark" cols="45" rows="5">${msg.obj.remark }</textarea>
		      </div>
		      <div class="clear"></div>
		    </div>
	    </form>
	  ...
	  <div class="tijsq_main_dibu">
	    <div  class="tijsq_main_dibu_nav"><a href="javascript:submit();">确认修改</a></div>
	  </div>
	</div>
	<!--======================bottom开始============================-->
