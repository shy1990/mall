...
<head>
  ...
  <style type="text/css">
    ...
    .wrap > .content > ul > li > table .collected {
      /*padding-left: 16px;
...
<div class="xq_mian" id="xq_mian" ms-controller="bjd">
            ...
            <td width="20" colspan="10">
              <ul id="filter_brand">
                <li ms-repeat="allBrand"><input type="checkbox"
                                                ms-attr-value="el" ms-duplex="brandRange"/>{{el}}
                </li>
              </ul>
            </td>
          </tr>
            ...
            <table ms-class-1="hot:goods.isHot" ms-class-2="new:goods.isNew"
              ...
              <tr>
                <td width="21" align="center" ms-class-1="icon"
                    ...
                    ms-text="goods.isNew?'新':goods.isHot?'热':''">热
                </td>
                ...
                <td width="30" class="price"><a target="_blank"
                                                ms-href="goods/detail/{{goods.goodsNum}}.html?s=bjd"
                                                ms-text="goods.price|currency">￥510</a>
                </td>
  ...
  <div id="content">
    ...
    <!--   <i id="dialog_close"
      ...
      <a href="/goods/toShopRush.html?s=menu"><img height="360px" width="734px"src="images/shoprush/redmipro.png"/> </a> -->
    </div>
  </div>
</div>
