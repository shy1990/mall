		...
		<div class="about_mian">
		  ...
		  <div class="about_mian_ret">
		    <div class="about_mian_ret_01">
		      <p><strong>网银支付</strong></p>
		    </div>
		    <div class="about_mian_ret_02">
		     <p>
               1.如果您想使用网上银行（包括开通了网银功能的储蓄卡和信用卡）支付货款，请在“提交订单”页面选择“银行卡支付”，然后选择您网银所属的银行。<br/>
			   2.提交订单后，商城页面会提示您“立即支付”，请单击立即支付按钮；商城页面会自动进入您所选择银行的网银支付界面。<br/>
			   3.在网银支付界面，请按照网页提示进行操作。
		     </p>
		    </div>
		  </div>
		<div class="clear"></div>
