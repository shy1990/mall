	       ...
	       <div class="phone_main_01_top">
	        ...
	        <div class="phone_main_01_top_let">&gt;</div>
	         <div class="phone_main_01_top_fit">
	          <div class="phone_main_01_top_fit_let"><input onkeydown="keyDownSearch(event)" id="phone_list_search_param" name="" type="text" value="在当前条件下搜索" onmouseover="this.focus()" onmouseout="if(this.value=='')this.value='在当前条件下搜索';" onfocus="this.select()" onclick="if(this.value=='在当前条件下搜索')this.value=''"></div>
