...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/myCenter/accountSecurity/fixPassword.js"></script>

</head>

<body onkeydown="keydown(event)">
<form action="member/modifyPsw.html" method="post">
<!--======================top开始============================-->
  ...
  <div class="wodz_ret">
      ...
      <div class="zhaq_main">
        <div class="xgmm_01">修改密码</div>
         <div class="xgmm_02">
           <div class="xgmm_03">
             <div class="xgmm_03_let">密码：</div><input type="hidden" id="tel" name="" value="${mobile}"/>
             <div class="xgmm_03_mid"><input type="password" id="oldpssword" name="oldpassword" onblur="validatedPsw()"/></div>
             <div class="xgmm_03_ret" id="existPsw"></div>
             <div class="clear"> </div>
           </div>
           <div class="xgmm_03">
             <div class="xgmm_03_let">新密码：</div>
           ...
           <div class="xgmm_03">
             <div class="xgmm_03_let">确认密码：</div>
