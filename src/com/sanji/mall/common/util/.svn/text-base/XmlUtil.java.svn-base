...
public class XmlUtil {
	...
	public static void main(String[] args) {
		String xmlString = "<?xml version=\"1.0\" encoding=\"utf-8\" ?>" + "<TradeOrdersNew>" + "<trade_orders_response>" + "<trade>" + "<created>2012-8-11 18:46:19</created>"
				+ "<tid>DD00006772</tid>" + "</trade>" + "</trade_orders_response>" + "</TradeOrdersNew>";
		try {
			Map<String, String> map = XmlUtil.xml2Map(xmlString);
			// System.out.println(map.get("TradeOrdersNew.trade_orders_response.trade.created"));
